 ...
 */
    ...
    public:
        ...
        */
        ...
        void receive()
        {
            serial_read((uint8_t*)&receive_data, sizeof(CAN_Receive_Frame));
        ...
        void receive_param()
        {
            serial_read(reinterpret_cast<uint8_t*>(&receive_data), sizeof(CAN_Receive_Frame));
    ...
    private:
        ...
        long serial_read(uint8_t* data, size_t max_len, long* ret_ch = nullptr)
        {
            unsigned char data_ptr[256] = {0};
            long channel = 0;
            long result = use_arm_b_ ? OnGetChDataB(data_ptr, &channel) : OnGetChDataA(data_ptr, &channel);
            ...
            if (result >= 12 && max_len >= sizeof(CAN_Receive_Frame))
            {
                ...
                frame->CMD = 0x11;          // receive success
                frame->canDataLen = 8;
                frame->canIde = 0;
                frame->canRtr = 0;
